...
import id.co.danamon.dbank.common.config.logger.ControllerLogger;
import id.co.danamon.dbank.common.config.logger.RestTemplateLogger;
import id.co.danamon.dbank.common.exception.MobileRestExceptionHandler;
...
public class RestTemplateConfiguration {
    ...
    @Value(value = "${logging.level.id.co.danamon.dbank.resttemplate.logger:DEBUG")
