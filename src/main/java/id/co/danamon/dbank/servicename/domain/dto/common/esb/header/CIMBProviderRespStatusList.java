...
@XmlType(name = "", propOrder = {
    "cimbProviderRespStatus"
})
public class CIMBProviderRespStatusList  {

    @XmlElement(name = "CIMB_ProviderRespStatus")
    protected CIMBProviderRespStatus cimbProviderRespStatus;
