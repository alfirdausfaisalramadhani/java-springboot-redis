...
public class CatControllerIT_UpdateCatOwnerDataTest {
    ...
    @Test
    public void updateCatOwnerDataSuccess() {
        ...
        given()
                ...
                .log().everything()
                .when()
                .post(serviceNamePrefix + "/cat/owner/update")
                .then()
                .log().everything()
                .assertThat()
    ...
    @Test
    public void updateCatOwnerDataNotFound() {
        Mockito.when(catService.updateCatOwner(any())).thenReturn(Optional.empty());
        given()
                .body(new CatOwnerDto(1l, "riska", "riska", Gender.WOMAN))
                .contentType(ApiVersion.V1)
                .accept(ContentType.JSON)
    ...
    @Test
    public void updateCatOwnerParameterInvalid() {
        given()
    ...
    @Test
    public void updateCatOwnerParameterInvalid2() {
        given()
                .body(new CatOwnerDto(1l, null, null, null))
                .contentType(ApiVersion.V1)
                .accept(ContentType.JSON)
                .log().everything()
                .when()
    ...
    @Test
    public void updateCatOwnerUnknownError() {
        Mockito.when(catService.updateCatOwner(any())).thenThrow(new NullPointerException());
        given()
                .body(new CatOwnerDto(1l, "riska", "riska", Gender.WOMAN))
                .contentType(ApiVersion.V1)
                .accept(ContentType.JSON)
